...
class contractController extends Controller
{
    public function store(Request $request)
    {
        ...
        $currentSales = Staff::where('user_id','=',Auth::user()->id)->firstOrFail();
        ...
        $contract->sales_id = $currentSales->id;
    ...
    public function update(Request $request)
    {
        ...
        $contract->payment = $request->get('payment');
        if ($contract->save()) {
    ...
    public function getExistingContract(){
        $contract= Contract::All();
        return view('contracts.existContract')->with(['contracts'=>$contract]);
    }
